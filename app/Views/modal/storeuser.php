    ...
    <div id="storeUserModal" class="hidden fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[130] p-4">
      <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-md transform transition-all overflow-hidden border dark:border-gray-800 flex flex-col">
        <div class="p-6 border-b dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 flex justify-between items-center">
          ...
          <button type="button" onclick="closeModal('storeUserModal')" class="cursor-pointer text-gray-400 hover:text-gray-600 dark:hover:text-gray-200">
            <i data-feather="x"></i>
          </button>
        </div>
        <form id="storeUserForm" onsubmit="event.preventDefault();" class="flex flex-col overflow-hidden">
          <div class="p-6 overflow-y-auto" style="max-height: 65vh;">
            ...
            <div id="storeManagementArea">
              <h4 class="font-bold text-gray-700 dark:text-white mb-4 flex items-center justify-between">
                ...
                <button type="button" onclick="addStoreRow()" class="cursor-pointer text-xs bg-blue-600 hover:bg-blue-700 text-white px-3 py-1.5 rounded-lg transition-colors flex items-center">
          ...
          <div class="p-6 border-t dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 flex gap-3">
            <button type="button" onclick="closeModal('storeUserModal')" class="cursor-pointer flex-1 px-4 py-3 border border-gray-300 dark:border-gray-700 text-gray-600 dark:text-gray-300 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 transition-all font-semibold">
              Batal
            </button>
            <button type="submit" id="saveUserStoreBtn" class="cursor-pointer flex-1 px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-semibold shadow-lg shadow-blue-200 dark:shadow-none transition-all active:scale-95">
              Simpan Data
            </button>
          </div>
        </form>
